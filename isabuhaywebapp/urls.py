...
urlpatterns = [
    ...
    path('CBCTestResults/<str:id>/', DisplayCBCTestResult.as_view(), name='DisplayCBCTestResult'),
    path('addingOptions/', DisplayAddingOptions.as_view(), name='DisplayAddingOptions'),
    path('paymentMethod/<str:type>/<str:id>/', PaymentMethod.as_view(), name='PaymentMethod'),
    ...
    path('CBCTestResult/create/<str:type>/<str:id>/', CreateCBCTestResult.as_view(), name='CreateCBCTestResult'),
    path('CBCTestResult/update/<str:id>/', UpdateCBCTestResult.as_view(), name='UpdateCBCTestResult'),
    path('CBCTestResult/delete/<str:id>/', DeleteCBCTestResult.as_view(), name='DeleteCBCTestResult'),
    path('uploadedImage/delete/<str:type>/<str:id>/', DeleteUploadedImage.as_view(), name='DeleteUploadedImage'),
    path('pdf/delete/<str:id>/', DeletePDF.as_view(), name='DeletePDF'),
    path('docx/delete/<str:id>/', DeleteDocx.as_view(), name='DeleteDocx'),
    ...
    path('chatbox/<str:id>', ChatBox.as_view(), name='chatbox'),
    ...
    path('getMessages/<str:id>', GetMessages.as_view(), name='getMessages'),
    path('deleteMessage/<str:id>', DeleteMessage.as_view(), name='deleteMessage'),
]
